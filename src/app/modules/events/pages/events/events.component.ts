...
import { IEvent, IEventConfig, InfoEvent } from 'src/app/models/event.model';
...
export class EventsComponent implements OnInit {
  ...
  eventCode: number = 0;
  selectedOption: string | null = localStorage.getItem('selectedOption');
  quorum: number = 0;
  message: string = '';
  messageError: string = '';
  href: string = 'quorum';
